...
class Admin::OrdersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_order" do
    assert_difference("Admin::Order.count") do
      post admin_orders_url, params: { admin_order: { adress: @admin_order.adress, customer_email: @admin_order.customer_email, fulfilled: @admin_order.fulfilled, total: @admin_order.total } }
    end
  ...
  test "should update admin_order" do
    patch admin_order_url(@admin_order), params: { admin_order: { adress: @admin_order.adress, customer_email: @admin_order.customer_email, fulfilled: @admin_order.fulfilled, total: @admin_order.total } }
